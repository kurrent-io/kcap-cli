...
/// <c>~/.config/opencode</c> (honoring <c>XDG_CONFIG_HOME</c>) and auto-loads
/// plugins from <c>~/.config/opencode/plugins/</c>; session data lives under
/// <c>~/.local/share/opencode</c> (honoring <c>XDG_DATA_HOME</c>).
///
...
public static class OpenCodePaths {
    public static string ConfigDir(string? home = null) {
