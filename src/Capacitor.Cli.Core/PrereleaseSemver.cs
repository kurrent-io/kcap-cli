...
public static class PrereleaseSemver {
    ...
    public static int Compare(string? a, string? b) {
        ...
        return pa switch {
            null when pb is null => 0,
            null                 => -1,
            _                    => pb is null ? 1 : CompareParsed(pa.Value, pb.Value)
        };
    }
    ...
    static int CompareParsed(V a, V b) {
        ...
        switch (aPre) {
            case false when !bPre:
                return 0;
            case true when !bPre:
                return -1; // 0.7.0-beta.1 < 0.7.0
            case false when bPre:
                return 1;
        }
