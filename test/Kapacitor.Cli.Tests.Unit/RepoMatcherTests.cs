...
/// <summary>
/// Behaviour tests for <see cref="Kapacitor.Cli.Daemon.Services.RepoMatcher"/>. Each test creates a real
/// git repo with a controlled <c>origin</c> remote and asserts that
/// <see cref="Kapacitor.Cli.Daemon.Services.RepoMatcher.FindAsync"/> returns the expected confirmed roots.
/// </summary>
