...
public class CursorPayloadAssemblerTests {
    ...
    public async Task Redacts_absolute_paths_to_relative() {
        var raw =
            """{"bubbleId":"e1","type":2,"capabilityType":15,"createdAt":"2026-05-21T00:00:00Z","toolFormerData":{"toolCallId":"tc","name":"edit_file_v2","params":"{\"relativeWorkspacePath\":\"/Users/me/code/foo/README.md\"}","result":"{}"}}""";
    ...
    public async Task Redacts_backslash_paths_when_repoPath_uses_forward_slash() {
        ...
        var raw =
            """{"bubbleId":"e1","type":2,"capabilityType":15,"createdAt":"2026-05-21T00:00:00Z","toolFormerData":{"toolCallId":"tc","name":"edit_file_v2","params":"{\"absPath\":\"C:\\\\Users\\\\me\\\\code\\\\foo\\\\X.cs\"}","result":"{}"}}""";
    ...
    public async Task Handles_object_typed_params_and_result() {
        ...
        var raw =
            """{"bubbleId":"b2","type":2,"capabilityType":15,"createdAt":"2026-05-21T00:00:00Z","toolFormerData":{"toolCallId":"tc2","name":"edit_file_v2","params":{"relativeWorkspacePath":"src/foo.cs"},"result":{"success":true}}}""";
        var bubble = CursorPayloadAssembler.AssembleBubble(raw, repoPath: "/repo/foo");
