...
public class ClaudeHookExclusionGateTests {
    ...
    ClaudeHookCommand Hook() => new(Config.Root, Resolutions.None(Config.Root), _clock, Home, TestHarnesses.Under(Home), HostedAgent.Terminal, new FixedCapacitorHttpClient(), new WatcherManager(Config.Root, Resolutions.None(Config.Root), new FixedCapacitorHttpClient()));
