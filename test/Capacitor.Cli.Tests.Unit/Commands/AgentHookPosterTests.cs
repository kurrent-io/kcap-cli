...
public class AgentHookPosterTests : IDisposable {
    ...
    AgentHookPoster  Poster => field ??= new(Config.Root, Resolutions.At(_server.Url!, Config.Root), new FixedCapacitorHttpClient(), new WatcherManager(Config.Root, Resolutions.At(_server.Url!, Config.Root), new FixedCapacitorHttpClient()));
